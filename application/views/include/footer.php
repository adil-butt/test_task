...
<script src="<?php echo base_url('public/assets/datatables/dataTables.bootstrap4.js') ?>"></script>
<!-- Demo scripts for this page-->
<script src="<?php echo base_url('public/assets/datatables/datatables-demo.js') ?>"></script>
...
<script src="<?php echo base_url('public/assets/js/admin-events.js') ?>"></script>
